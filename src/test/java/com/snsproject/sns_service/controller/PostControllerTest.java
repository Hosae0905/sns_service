...
import com.snsproject.sns_service.controller.request.PostModifyRequest;
...
public class PostControllerTest {
    ...
    void 포스트수정() throws Exception {
        ...
        when(postService.modify(eq(title), eq(body), any(), any())).thenReturn(Post.fromEntity(PostEntityFixture.get(
                "userName", 1, 1
        )));
